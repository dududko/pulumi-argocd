...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 client_cert_key: Optional[pulumi.Input[builtins.str]] = None,
                 config_path: Optional[pulumi.Input[builtins.str]] = None,
                 context: Optional[pulumi.Input[builtins.str]] = None,
                 core: Optional[pulumi.Input[builtins.bool]] = None,
                 grpc_web: Optional[pulumi.Input[builtins.bool]] = None,
                 grpc_web_root_path: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 plain_text: Optional[pulumi.Input[builtins.bool]] = None,
                 port_forward: Optional[pulumi.Input[builtins.bool]] = None,
                 port_forward_with_namespace: Optional[pulumi.Input[builtins.str]] = None,
                 server_addr: Optional[pulumi.Input[builtins.str]] = None,
                 use_local_config: Optional[pulumi.Input[builtins.bool]] = None,
                 user_agent: Optional[pulumi.Input[builtins.str]] = None,
                 username: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Provider resource.
        :param pulumi.Input[builtins.str] auth_token: ArgoCD authentication token, takes precedence over `username`/`password`. Can be set through the `ARGOCD_AUTH_TOKEN`
               environment variable.
        :param pulumi.Input[builtins.str] cert_file: Additional root CA certificates file to add to the client TLS connection pool.
        :param pulumi.Input[builtins.str] client_cert_file: Client certificate.
        :param pulumi.Input[builtins.str] client_cert_key: Client certificate key.
        :param pulumi.Input[builtins.str] config_path: Override the default config path of `$HOME/.config/argocd/config`. Only relevant when `use_local_config`. Can be set
               through the `ARGOCD_CONFIG_PATH` environment variable.
        :param pulumi.Input[builtins.str] context: Context to choose when using a local ArgoCD config file. Only relevant when `use_local_config`. Can be set through
               `ARGOCD_CONTEXT` environment variable.
        :param pulumi.Input[builtins.bool] core: Configure direct access using Kubernetes API server. **Warning**: this feature works by starting a local ArgoCD API
        ...
        :param pulumi.Input[builtins.bool] grpc_web: Whether to use gRPC web proxy client. Useful if Argo CD server is behind proxy which does not support HTTP2.
        :param pulumi.Input[builtins.str] grpc_web_root_path: Use the gRPC web proxy client and set the web root, e.g. `argo-cd`. Useful if the Argo CD server is behind a proxy at a
               non-root path.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] headers: Additional headers to add to each request to the ArgoCD server.
        :param pulumi.Input[builtins.bool] insecure: Whether to skip TLS server certificate. Can be set through the `ARGOCD_INSECURE` environment variable.
        ...
        :param pulumi.Input[builtins.str] password: Authentication password. Can be set through the `ARGOCD_AUTH_PASSWORD` environment variable.
        :param pulumi.Input[builtins.bool] plain_text: Whether to initiate an unencrypted connection to ArgoCD server.
        :param pulumi.Input[builtins.bool] port_forward: Connect to a random argocd-server port using port forwarding.
        :param pulumi.Input[builtins.str] port_forward_with_namespace: Namespace name which should be used for port forwarding.
        :param pulumi.Input[builtins.str] server_addr: ArgoCD server address with port. Can be set through the `ARGOCD_SERVER` environment variable.
        :param pulumi.Input[builtins.bool] use_local_config: Use the authentication settings found in the local config file. Useful when you have previously logged in using SSO.
               Conflicts with `auth_token`, `username` and `password`.
        :param pulumi.Input[builtins.str] user_agent: User-Agent request header override.
        :param pulumi.Input[builtins.str] username: Authentication username. Can be set through the `ARGOCD_AUTH_USERNAME` environment variable.
        """
    ...
    def client_cert_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_cert_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def core(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @core.setter
    def core(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "core", value)

    @property
    @pulumi.getter(name="grpcWeb")
    def grpc_web(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @grpc_web.setter
    def grpc_web(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "grpc_web", value)

    @property
    @pulumi.getter(name="grpcWebRootPath")
    def grpc_web_root_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def grpc_web_root_path(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def plain_text(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @plain_text.setter
    def plain_text(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "plain_text", value)

    @property
    @pulumi.getter(name="portForward")
    def port_forward(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @port_forward.setter
    def port_forward(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "port_forward", value)

    @property
    @pulumi.getter(name="portForwardWithNamespace")
    def port_forward_with_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def port_forward_with_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def use_local_config(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_local_config(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Provider(pulumi.ProviderResource):
    ...
    pulumi_type = "pulumi:providers:argocd"
    ...
    @property
    @pulumi.getter(name="clientCertKey")
    def client_cert_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Client certificate key.
        """
        return pulumi.get(self, "client_cert_key")
    ...
    @property
    @pulumi.getter(name="grpcWebRootPath")
    def grpc_web_root_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Use the gRPC web proxy client and set the web root, e.g. `argo-cd`. Useful if the Argo CD server is behind a proxy at a
        non-root path.
        """
    ...
    @property
    @pulumi.getter(name="portForwardWithNamespace")
    def port_forward_with_namespace(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Namespace name which should be used for port forwarding.
        """
        return pulumi.get(self, "port_forward_with_namespace")
    ...
    @property
    @pulumi.getter(name="serverAddr")
    def server_addr(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ArgoCD server address with port. Can be set through the `ARGOCD_SERVER` environment variable.
        """
        return pulumi.get(self, "server_addr")
