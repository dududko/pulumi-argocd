...
class ProjectTokenArgs:
    def __init__(__self__, *,
                 ...
                 expires_in: Optional[pulumi.Input[builtins.str]] = None,
                 renew_after: Optional[pulumi.Input[builtins.str]] = None,
                 renew_before: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ProjectToken resource.
        :param pulumi.Input[builtins.str] project: The project associated with the token.
        :param pulumi.Input[builtins.str] role: The name of the role in the project associated with the token.
        :param pulumi.Input[builtins.str] description: Description of the token.
        :param pulumi.Input[builtins.str] expires_in: Duration before the token will expire. Valid time units are `ns`, `us` (or `µs`), `ms`, `s`, `m`, `h`. E.g. `12h`, `7d`. Default: No expiration.
        :param pulumi.Input[builtins.str] renew_after: Duration to control token silent regeneration based on token age. Valid time units are `ns`, `us` (or `µs`), `ms`, `s`, `m`, `h`. If set, then the token will be regenerated if it is older than `renew_after`. I.e. if `currentDate - issued_at > renew_after`.
        :param pulumi.Input[builtins.str] renew_before: Duration to control token silent regeneration based on remaining token lifetime. If `expires_in` is set, the provider will regenerate the token if `expires_at - currentDate < renew_before`. Valid time units are `ns`, `us` (or `µs`), `ms`, `s`, `m`, `h`.
        """
    ...
    def expires_in(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @expires_in.setter
    def expires_in(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "expires_in", value)

    @property
    @pulumi.getter(name="renewAfter")
    def renew_after(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @renew_after.setter
    def renew_after(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ProjectTokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Description of the token.
        :param pulumi.Input[builtins.str] expires_at: If `expires_in` is set, Unix timestamp upon which the token will expire.
        :param pulumi.Input[builtins.str] expires_in: Duration before the token will expire. Valid time units are `ns`, `us` (or `µs`), `ms`, `s`, `m`, `h`. E.g. `12h`, `7d`. Default: No expiration.
        :param pulumi.Input[builtins.str] issued_at: Unix timestamp at which the token was issued.
        :param pulumi.Input[builtins.str] jwt: The raw JWT.
        :param pulumi.Input[builtins.str] project: The project associated with the token.
        :param pulumi.Input[builtins.str] renew_after: Duration to control token silent regeneration based on token age. Valid time units are `ns`, `us` (or `µs`), `ms`, `s`, `m`, `h`. If set, then the token will be regenerated if it is older than `renew_after`. I.e. if `currentDate - issued_at > renew_after`.
        :param pulumi.Input[builtins.str] renew_before: Duration to control token silent regeneration based on remaining token lifetime. If `expires_in` is set, the provider will regenerate the token if `expires_at - currentDate < renew_before`. Valid time units are `ns`, `us` (or `µs`), `ms`, `s`, `m`, `h`.
        :param pulumi.Input[builtins.str] role: The name of the role in the project associated with the token.
...
class ProjectToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            renew_after: Optional[pulumi.Input[builtins.str]] = None,
            renew_before: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'ProjectToken':
        """
    ...
    @property
    @pulumi.getter(name="expiresIn")
    def expires_in(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Duration before the token will expire. Valid time units are `ns`, `us` (or `µs`), `ms`, `s`, `m`, `h`. E.g. `12h`, `7d`. Default: No expiration.
        """
        return pulumi.get(self, "expires_in")
    ...
    @property
    @pulumi.getter
    def jwt(self) -> pulumi.Output[builtins.str]:
        """
        The raw JWT.
        """
        return pulumi.get(self, "jwt")
    ...
    @property
    @pulumi.getter(name="renewAfter")
    def renew_after(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Duration to control token silent regeneration based on token age. Valid time units are `ns`, `us` (or `µs`), `ms`, `s`, `m`, `h`. If set, then the token will be regenerated if it is older than `renew_after`. I.e. if `currentDate - issued_at > renew_after`.
        """
        return pulumi.get(self, "renew_after")
    ...
    @property
    @pulumi.getter(name="renewBefore")
    def renew_before(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Duration to control token silent regeneration based on remaining token lifetime. If `expires_in` is set, the provider will regenerate the token if `expires_at - currentDate < renew_before`. Valid time units are `ns`, `us` (or `µs`), `ms`, `s`, `m`, `h`.
        """
        return pulumi.get(self, "renew_before")
