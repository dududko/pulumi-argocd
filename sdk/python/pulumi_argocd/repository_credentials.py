...
class RepositoryCredentialsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] url: URL that these credentials matches to.
        :param pulumi.Input[builtins.bool] enable_oci: Whether `helm-oci` support should be enabled for this repo.
        :param pulumi.Input[builtins.str] githubapp_enterprise_base_url: GitHub API URL for GitHub app authentication.
        :param pulumi.Input[builtins.str] githubapp_id: Github App ID of the app used to access the repo for GitHub app authentication.
        :param pulumi.Input[builtins.str] githubapp_installation_id: ID of the installed GitHub App for GitHub app authentication.
        :param pulumi.Input[builtins.str] githubapp_private_key: Private key data (PEM) for authentication via GitHub app.
        :param pulumi.Input[builtins.str] password: Password for authenticating at the repo server.
        :param pulumi.Input[builtins.str] ssh_private_key: Private key data for authenticating at the repo server using SSH (only Git repos).
        :param pulumi.Input[builtins.str] tls_client_cert_data: TLS client cert data for authenticating at the repo server.
        :param pulumi.Input[builtins.str] tls_client_cert_key: TLS client cert key for authenticating at the repo server.
        :param pulumi.Input[builtins.str] username: Username for authenticating at the repo server.
        """
...
class RepositoryCredentials(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tls_client_cert_key: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'RepositoryCredentials':
        """
