...
class RepositoryArgs:
    def __init__(__self__, *,
                 ...
                 githubapp_enterprise_base_url: Optional[pulumi.Input[builtins.str]] = None,
                 githubapp_id: Optional[pulumi.Input[builtins.str]] = None,
                 githubapp_installation_id: Optional[pulumi.Input[builtins.str]] = None,
                 githubapp_private_key: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] repo: URL of the repository.
        :param pulumi.Input[builtins.bool] enable_lfs: Whether `git-lfs` support should be enabled for this repository.
        :param pulumi.Input[builtins.bool] enable_oci: Whether `helm-oci` support should be enabled for this repository.
        :param pulumi.Input[builtins.str] githubapp_enterprise_base_url: GitHub API URL for GitHub app authentication.
        :param pulumi.Input[builtins.str] githubapp_id: ID of the GitHub app used to access the repo.
        :param pulumi.Input[builtins.str] githubapp_installation_id: The installation ID of the GitHub App used to access the repo.
        :param pulumi.Input[builtins.str] githubapp_private_key: Private key data (PEM) for authentication via GitHub app.
        :param pulumi.Input[builtins.bool] insecure: Whether the connection to the repository ignores any errors when verifying TLS certificates or SSH host keys.
        :param pulumi.Input[builtins.str] name: Name to be used for this repo. Only used with Helm repos.
        :param pulumi.Input[builtins.str] password: Password or PAT used for authenticating at the remote repository.
        :param pulumi.Input[builtins.str] project: The project name, in case the repository is project scoped.
        :param pulumi.Input[builtins.str] ssh_private_key: PEM data for authenticating at the repo server. Only used with Git repos.
        :param pulumi.Input[builtins.str] tls_client_cert_data: TLS client certificate in PEM format for authenticating at the repo server.
        :param pulumi.Input[builtins.str] tls_client_cert_key: TLS client certificate private key in PEM format for authenticating at the repo server.
        :param pulumi.Input[builtins.str] type: Type of the repo. Can be either `git` or `helm`. `git` is assumed if empty or absent.
        :param pulumi.Input[builtins.str] username: Username used for authenticating at the remote repository.
        """
    ...
    def githubapp_enterprise_base_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def githubapp_enterprise_base_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "githubapp_enterprise_base_url", value)

    @property
    @pulumi.getter(name="githubappId")
    def githubapp_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @githubapp_id.setter
    def githubapp_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "githubapp_id", value)

    @property
    @pulumi.getter(name="githubappInstallationId")
    def githubapp_installation_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def githubapp_installation_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "githubapp_installation_id", value)

    @property
    @pulumi.getter(name="githubappPrivateKey")
    def githubapp_private_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def githubapp_private_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RepositoryState:
    def __init__(__self__, *,
                 connection_state_status: Optional[pulumi.Input[builtins.str]] = None,
                 enable_lfs: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_oci: Optional[pulumi.Input[builtins.bool]] = None,
                 githubapp_enterprise_base_url: Optional[pulumi.Input[builtins.str]] = None,
                 githubapp_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] connection_state_status: Contains information about the current state of connection to the repository server.
        :param pulumi.Input[builtins.bool] enable_lfs: Whether `git-lfs` support should be enabled for this repository.
        :param pulumi.Input[builtins.bool] enable_oci: Whether `helm-oci` support should be enabled for this repository.
        :param pulumi.Input[builtins.str] githubapp_enterprise_base_url: GitHub API URL for GitHub app authentication.
        :param pulumi.Input[builtins.str] githubapp_id: ID of the GitHub app used to access the repo.
        :param pulumi.Input[builtins.str] githubapp_installation_id: The installation ID of the GitHub App used to access the repo.
        :param pulumi.Input[builtins.str] githubapp_private_key: Private key data (PEM) for authentication via GitHub app.
        :param pulumi.Input[builtins.bool] inherited_creds: Whether credentials were inherited from a credential set.
        :param pulumi.Input[builtins.bool] insecure: Whether the connection to the repository ignores any errors when verifying TLS certificates or SSH host keys.
        :param pulumi.Input[builtins.str] name: Name to be used for this repo. Only used with Helm repos.
        :param pulumi.Input[builtins.str] password: Password or PAT used for authenticating at the remote repository.
        :param pulumi.Input[builtins.str] project: The project name, in case the repository is project scoped.
    ...
    def connection_state_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connection_state_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Repository(pulumi.CustomResource):
    ...
    pulumi_type = "argocd:index/repository:Repository"
    ...
    def get(resource_name: str,
            ...
            tls_client_cert_key: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'Repository':
        """
    ...
    @property
    @pulumi.getter(name="connectionStateStatus")
    def connection_state_status(self) -> pulumi.Output[builtins.str]:
        """
        Contains information about the current state of connection to the repository server.
        """
        return pulumi.get(self, "connection_state_status")
    ...
    @property
    @pulumi.getter(name="enableLfs")
    def enable_lfs(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether `git-lfs` support should be enabled for this repository.
        """
        return pulumi.get(self, "enable_lfs")
    ...
    @property
    @pulumi.getter(name="enableOci")
    def enable_oci(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether `helm-oci` support should be enabled for this repository.
        """
        return pulumi.get(self, "enable_oci")
    ...
    @property
    @pulumi.getter(name="githubappEnterpriseBaseUrl")
    def githubapp_enterprise_base_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        GitHub API URL for GitHub app authentication.
        """
        return pulumi.get(self, "githubapp_enterprise_base_url")
    ...
    @property
    @pulumi.getter(name="githubappId")
    def githubapp_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ID of the GitHub app used to access the repo.
        """
        return pulumi.get(self, "githubapp_id")
    ...
    @property
    @pulumi.getter(name="githubappInstallationId")
    def githubapp_installation_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The installation ID of the GitHub App used to access the repo.
        """
        return pulumi.get(self, "githubapp_installation_id")
    ...
    @property
    @pulumi.getter(name="githubappPrivateKey")
    def githubapp_private_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Private key data (PEM) for authentication via GitHub app.
        """
        return pulumi.get(self, "githubapp_private_key")
    ...
    @property
    @pulumi.getter(name="inheritedCreds")
    def inherited_creds(self) -> pulumi.Output[builtins.bool]:
        """
        Whether credentials were inherited from a credential set.
        """
        return pulumi.get(self, "inherited_creds")
    ...
    @property
    @pulumi.getter
    def repo(self) -> pulumi.Output[builtins.str]:
        """
        URL of the repository.
        """
        return pulumi.get(self, "repo")
    ...
    @property
    @pulumi.getter(name="sshPrivateKey")
    def ssh_private_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        PEM data for authenticating at the repo server. Only used with Git repos.
        """
        return pulumi.get(self, "ssh_private_key")
    ...
    @property
    @pulumi.getter(name="tlsClientCertData")
    def tls_client_cert_data(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        TLS client certificate in PEM format for authenticating at the repo server.
        """
        return pulumi.get(self, "tls_client_cert_data")
    ...
    @property
    @pulumi.getter(name="tlsClientCertKey")
    def tls_client_cert_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        TLS client certificate private key in PEM format for authenticating at the repo server.
        """
        return pulumi.get(self, "tls_client_cert_key")
