...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the cluster. If omitted, will use the server address.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] namespaces: List of namespaces which are accessible in that cluster. Cluster level resources would be ignored if namespace list is not empty.
        :param pulumi.Input[_builtins.str] project: Reference between project and cluster that allow you automatically to be added as item inside Destinations project entity. More info: https://argo-cd.readthedocs.io/en/stable/user-guide/projects/#project-scoped-repositories-and-clusters.
        :param pulumi.Input[_builtins.str] server: Server is the API server URL of the Kubernetes cluster.
        :param pulumi.Input[_builtins.str] shard: Optional shard number. Calculated on the fly by the application controller if not specified.
        """
...
@pulumi.type_token("argocd:index/cluster:Cluster")
class Cluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[_builtins.str]] = None,
            server: Optional[pulumi.Input[_builtins.str]] = None,
            shard: Optional[pulumi.Input[_builtins.str]] = None) -> 'Cluster':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def shard(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Optional shard number. Calculated on the fly by the application controller if not specified.
        """
        return pulumi.get(self, "shard")
