...
class AccountTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account: Account name. Defaults to the current account. I.e. the account configured on the `provider` block.
        ...
        :param pulumi.Input[builtins.str] renew_before: Duration to control token silent regeneration based on remaining token lifetime. If `expires_in` is set, Pulumi will regenerate the token if `expires_at - currentDate < renew_before`. Valid time units are `ns`, `us` (or `µs`), `ms`, `s`, `m`, `h`.
        """
...
class AccountToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            jwt: Optional[pulumi.Input[builtins.str]] = None,
            renew_after: Optional[pulumi.Input[builtins.str]] = None,
            renew_before: Optional[pulumi.Input[builtins.str]] = None) -> 'AccountToken':
        """
