...
class AccountTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] account: Account name. Defaults to the current account. I.e. the account configured on the `provider` block.
        :param pulumi.Input[_builtins.str] expires_in: Duration before the token will expire. Valid time units are `ns`, `us` (or `µs`), `ms`, `s`, `m`, `h`. E.g. `12h`, `7d`. Default: No expiration.
        ...
        :param pulumi.Input[_builtins.str] renew_before: Duration to control token silent regeneration based on remaining token lifetime. If `expires_in` is set, Pulumi will regenerate the token if `expires_at - currentDate < renew_before`. Valid time units are `ns`, `us` (or `µs`), `ms`, `s`, `m`, `h`.
        """
...
@pulumi.type_token("argocd:index/accountToken:AccountToken")
