...
namespace Three14.Argocd.Inputs
{
    ...
    public sealed class ApplicationSpecSourceKustomizePatchGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("options")]
        ...
        public Input<Inputs.ApplicationSpecSourceKustomizePatchTargetGetArgs> Target { get; set; } = null!;

        public ApplicationSpecSourceKustomizePatchGetArgs()
        {
        }
        public static new ApplicationSpecSourceKustomizePatchGetArgs Empty => new ApplicationSpecSourceKustomizePatchGetArgs();
    }
}
