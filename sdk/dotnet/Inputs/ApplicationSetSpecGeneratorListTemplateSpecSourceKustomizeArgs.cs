...
namespace Three14.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorListTemplateSpecSourceKustomizeArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("patches")]
        private InputList<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceKustomizePatchArgs>? _patches;

        /// <summary>
        /// A list of [Kustomize patches](https://kubectl.docs.kubernetes.io/references/kustomize/kustomization/patches/) to apply.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceKustomizePatchArgs> Patches
        {
            get => _patches ?? (_patches = new InputList<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceKustomizePatchArgs>());
            set => _patches = value;
        }
