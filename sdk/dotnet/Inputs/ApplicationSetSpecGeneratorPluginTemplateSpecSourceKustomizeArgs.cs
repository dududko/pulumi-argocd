...
namespace Three14.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorPluginTemplateSpecSourceKustomizeArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("patches")]
        private InputList<Inputs.ApplicationSetSpecGeneratorPluginTemplateSpecSourceKustomizePatchArgs>? _patches;

        /// <summary>
        /// A list of [Kustomize patches](https://kubectl.docs.kubernetes.io/references/kustomize/kustomization/patches/) to apply.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecGeneratorPluginTemplateSpecSourceKustomizePatchArgs> Patches
        {
            get => _patches ?? (_patches = new InputList<Inputs.ApplicationSetSpecGeneratorPluginTemplateSpecSourceKustomizePatchArgs>());
            set => _patches = value;
        }
        ...
        public ApplicationSetSpecGeneratorPluginTemplateSpecSourceKustomizeArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorPluginTemplateSpecSourceKustomizeArgs Empty => new ApplicationSetSpecGeneratorPluginTemplateSpecSourceKustomizeArgs();
    }
}
