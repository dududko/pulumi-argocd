...
namespace Three14.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorMergeTemplateSpecSourceKustomizeGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("patches")]
        private InputList<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceKustomizePatchGetArgs>? _patches;

        /// <summary>
        /// A list of [Kustomize patches](https://kubectl.docs.kubernetes.io/references/kustomize/kustomization/patches/) to apply.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceKustomizePatchGetArgs> Patches
        {
            get => _patches ?? (_patches = new InputList<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceKustomizePatchGetArgs>());
            set => _patches = value;
        }
