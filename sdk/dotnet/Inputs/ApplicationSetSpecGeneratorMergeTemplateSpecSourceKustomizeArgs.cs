...
namespace Three14.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorMergeTemplateSpecSourceKustomizeArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("patches")]
        private InputList<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceKustomizePatchArgs>? _patches;

        /// <summary>
        /// A list of [Kustomize patches](https://kubectl.docs.kubernetes.io/references/kustomize/kustomization/patches/) to apply.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceKustomizePatchArgs> Patches
        {
            get => _patches ?? (_patches = new InputList<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceKustomizePatchArgs>());
            set => _patches = value;
        }
