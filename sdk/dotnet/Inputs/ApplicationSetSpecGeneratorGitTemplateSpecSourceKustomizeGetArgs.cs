...
namespace Three14.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorGitTemplateSpecSourceKustomizeGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("patches")]
        private InputList<Inputs.ApplicationSetSpecGeneratorGitTemplateSpecSourceKustomizePatchGetArgs>? _patches;

        /// <summary>
        /// A list of [Kustomize patches](https://kubectl.docs.kubernetes.io/references/kustomize/kustomization/patches/) to apply.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecGeneratorGitTemplateSpecSourceKustomizePatchGetArgs> Patches
        {
            get => _patches ?? (_patches = new InputList<Inputs.ApplicationSetSpecGeneratorGitTemplateSpecSourceKustomizePatchGetArgs>());
            set => _patches = value;
        }
