...
namespace Three14.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorPluginTemplateSpecSourceKustomizeGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("patches")]
        private InputList<Inputs.ApplicationSetSpecGeneratorPluginTemplateSpecSourceKustomizePatchGetArgs>? _patches;

        /// <summary>
        /// A list of [Kustomize patches](https://kubectl.docs.kubernetes.io/references/kustomize/kustomization/patches/) to apply.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecGeneratorPluginTemplateSpecSourceKustomizePatchGetArgs> Patches
        {
            get => _patches ?? (_patches = new InputList<Inputs.ApplicationSetSpecGeneratorPluginTemplateSpecSourceKustomizePatchGetArgs>());
            set => _patches = value;
        }
        ...
        public ApplicationSetSpecGeneratorPluginTemplateSpecSourceKustomizeGetArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorPluginTemplateSpecSourceKustomizeGetArgs Empty => new ApplicationSetSpecGeneratorPluginTemplateSpecSourceKustomizeGetArgs();
    }
}
