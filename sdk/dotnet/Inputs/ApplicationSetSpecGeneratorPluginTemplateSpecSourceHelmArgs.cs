...
namespace Three14.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorPluginTemplateSpecSourceHelmArgs : global::Pulumi.ResourceArgs
    {
        [Input("fileParameters")]
        private InputList<Inputs.ApplicationSetSpecGeneratorPluginTemplateSpecSourceHelmFileParameterArgs>? _fileParameters;

        /// <summary>
        /// File parameters for the helm template.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecGeneratorPluginTemplateSpecSourceHelmFileParameterArgs> FileParameters
        {
            get => _fileParameters ?? (_fileParameters = new InputList<Inputs.ApplicationSetSpecGeneratorPluginTemplateSpecSourceHelmFileParameterArgs>());
        ...
        [Input("parameters")]
        private InputList<Inputs.ApplicationSetSpecGeneratorPluginTemplateSpecSourceHelmParameterArgs>? _parameters;

        /// <summary>
        /// Helm parameters which are passed to the helm template command upon manifest generation.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecGeneratorPluginTemplateSpecSourceHelmParameterArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.ApplicationSetSpecGeneratorPluginTemplateSpecSourceHelmParameterArgs>());
        ...
        public ApplicationSetSpecGeneratorPluginTemplateSpecSourceHelmArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorPluginTemplateSpecSourceHelmArgs Empty => new ApplicationSetSpecGeneratorPluginTemplateSpecSourceHelmArgs();
    }
}
