...
namespace Three14.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecGeneratorMergeGeneratorMergeGeneratorPluginInput
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ApplicationSetSpecGeneratorMergeGeneratorMergeGeneratorPluginInput(ImmutableDictionary<string, string> parameters)
        {
