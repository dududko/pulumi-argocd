...
namespace Three14.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecTemplateSpecSourceKustomizePatch
    {
        /// <summary>
        ...
        /// Target(s) to patch
        /// </summary>
        public readonly Outputs.ApplicationSetSpecTemplateSpecSourceKustomizePatchTarget Target;

        [OutputConstructor]
        private ApplicationSetSpecTemplateSpecSourceKustomizePatch(
            ...
            Outputs.ApplicationSetSpecTemplateSpecSourceKustomizePatchTarget target)
        {
            Options = options;
            Patch = patch;
            Path = path;
