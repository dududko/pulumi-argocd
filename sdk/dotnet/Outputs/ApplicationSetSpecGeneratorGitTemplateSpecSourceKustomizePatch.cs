...
namespace Three14.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecGeneratorGitTemplateSpecSourceKustomizePatch
    {
        /// <summary>
        ...
        /// Target(s) to patch
        /// </summary>
        public readonly Outputs.ApplicationSetSpecGeneratorGitTemplateSpecSourceKustomizePatchTarget Target;

        [OutputConstructor]
        private ApplicationSetSpecGeneratorGitTemplateSpecSourceKustomizePatch(
            ...
            Outputs.ApplicationSetSpecGeneratorGitTemplateSpecSourceKustomizePatchTarget target)
        {
            Options = options;
            Patch = patch;
            Path = path;
