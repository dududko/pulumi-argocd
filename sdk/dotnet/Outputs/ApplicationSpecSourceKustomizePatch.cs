...
namespace Three14.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSpecSourceKustomizePatch
    {
        /// <summary>
        ...
        /// Target(s) to patch
        /// </summary>
        public readonly Outputs.ApplicationSpecSourceKustomizePatchTarget Target;

        [OutputConstructor]
        private ApplicationSpecSourceKustomizePatch(
            ...
            Outputs.ApplicationSpecSourceKustomizePatchTarget target)
        {
            Options = options;
            Patch = patch;
            Path = path;
