...
namespace Three14.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecGeneratorMergeTemplateSpecSourceKustomizePatch
    {
        /// <summary>
        ...
        /// Target(s) to patch
        /// </summary>
        public readonly Outputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceKustomizePatchTarget Target;

        [OutputConstructor]
        private ApplicationSetSpecGeneratorMergeTemplateSpecSourceKustomizePatch(
            ...
            Outputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceKustomizePatchTarget target)
        {
            Options = options;
            Patch = patch;
            Path = path;
