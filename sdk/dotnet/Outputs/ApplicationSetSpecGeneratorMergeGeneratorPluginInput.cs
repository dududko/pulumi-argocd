...
namespace Three14.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecGeneratorMergeGeneratorPluginInput
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ApplicationSetSpecGeneratorMergeGeneratorPluginInput(ImmutableDictionary<string, string> parameters)
        {
