...
namespace Three14.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecGeneratorPluginTemplateSpecSyncPolicyRetryBackoff
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ApplicationSetSpecGeneratorPluginTemplateSpecSyncPolicyRetryBackoff(
            string? duration,
