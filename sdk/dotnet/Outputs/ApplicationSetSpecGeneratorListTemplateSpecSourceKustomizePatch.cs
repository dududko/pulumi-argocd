...
namespace Three14.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecGeneratorListTemplateSpecSourceKustomizePatch
    {
        /// <summary>
        ...
        /// Target(s) to patch
        /// </summary>
        public readonly Outputs.ApplicationSetSpecGeneratorListTemplateSpecSourceKustomizePatchTarget Target;

        [OutputConstructor]
        private ApplicationSetSpecGeneratorListTemplateSpecSourceKustomizePatch(
            ...
            Outputs.ApplicationSetSpecGeneratorListTemplateSpecSourceKustomizePatchTarget target)
        {
            Options = options;
            Patch = patch;
            Path = path;
